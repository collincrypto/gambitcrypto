// Copyright (c) 2014 The Gambit developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("gambit-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("gambit-smsg-pow"); // Make this thread recognisable
